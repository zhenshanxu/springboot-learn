...
public class RedisService {
    ...
    public long getExpire(String key) {
        long expire = 0;
        if (!key.isEmpty()) {
            expire = Long.parseLong(String.valueOf(redisTemplate.getExpire(key, TimeUnit.SECONDS)));
        }
        return expire;
    }
    ...
    public boolean hasKey(String key) {
        boolean flag = Boolean.FALSE;
        try {
            flag = Boolean.TRUE.equals(redisTemplate.hasKey(key));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return flag;
     ...
     */
    public void del(Collection<Object> keys) {
     ...
     */
    public void hdel(String key, Collection<Object> items) {
     ...
     * @return 成功个数
     */
    public long sSet(String key, Collection<Object> values) {
        try {
